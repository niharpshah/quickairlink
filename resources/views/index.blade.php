...
<meta property="twitter:image" content="https://uideck.com/wp-content/uploads/2021/09/play-meta-bs.jpg">
  ...
  <body>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key={{ config('apikey.MAPS_KEY') }}&callback=initMap&libraries=places&v=weekly" defer></script>
    <script src="https://maps.googleapis.com/maps/api/js?key={{ config('apikey.MAPS_KEY') }}&libraries=places&callback=initAutocomplete" async defer></script>
    <script src="../assets/js/booktaxi.js"></script>
